...
/**
 * Standard chrome around every craft: registry metadata, variant tabs
 * for comparing flows, the annotations toggle (`a`), and the notes panel.
 */
export function CraftFrame(props: {
  slug: string
  variants?: Array<CraftVariant>
        ...
        <ScrollArea className="min-h-0 flex-1 px-4 pb-4">
          {entries.length === 0 ? (
            <p className="text-paragraph-xs text-text-muted">
              No annotations in this craft yet. Wrap any element in{' '}
